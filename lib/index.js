...
var Client = /** @class */ (function () {
    function Client(network, etherscanApiKey, providersOpts, phrase, vault) {
        var _this = this;
        ...
        if (phrase && !src_6(phrase)) {
            ...
            this._provider = providersOpts
                ? new providers.FallbackProvider([
                    {
                        provider: new providers.InfuraProvider(network, providersOpts.infura.apiKey),
                        weight: providersOpts.infura.weight,
                        priority: providersOpts.infura.priority,
                    },
                    {
                        provider: new providers.EtherscanProvider(network, providersOpts.etherscan.apiKey),
            ...
            this._etherscan = new providers.EtherscanProvider(this._network, etherscanApiKey); // for tx history
            if (vault)
                this.setVault(vault);
            // Connects to the ethereum network with it
            var newWallet = this.wallet.connect(this._provider);
     ...
     */
    Client.prototype.EtherscanProvider = function (apiKey) {
        var newWallet = this.wallet.connect(new providers.EtherscanProvider(this._network, apiKey));
        this.changeWallet(newWallet);
     ...
     */
    Client.prototype.InfuraProvider = function (apiKey) {
        var newWallet = this.wallet.connect(new providers.InfuraProvider(this._network, apiKey));
        this.changeWallet(newWallet);
        return (this._provider = this._wallet.provider);
    };
    /**
