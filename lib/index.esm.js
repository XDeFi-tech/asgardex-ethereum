...
import { EtherscanProvider, InfuraProvider, getDefaultProvider, FallbackProvider } from '@ethersproject/providers';
...
var Client = /** @class */ (function () {
    ...
    Client.prototype.EtherscanProvider = function (apiKey) {
        var newWallet = this.wallet.connect(new EtherscanProvider(this._network, apiKey));
        this.changeWallet(newWallet);
    ...
    Client.prototype.InfuraProvider = function (apiKey) {
        var newWallet = this.wallet.connect(new InfuraProvider(this._network, apiKey));
        this.changeWallet(newWallet);
        return (this._provider = this._wallet.provider);
    };
    /**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.vault.deposit(toUtf8String(memo), { value: amount })];
                    ...
                    case 5:
                        _a.sent();
                        _a.label = 6;
                    case 6: return [4 /*yield*/, this.vault.deposit(asset, amount, toUtf8String(memo))];
                    case 7:
                        deposit = _a.sent();
